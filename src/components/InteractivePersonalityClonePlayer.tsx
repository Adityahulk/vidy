...
const demoVideos = [
  {
    ...
    isInteractive: true,
    personalityOptions: [
      { id: 'original', name: 'Original Sarah', icon: '👩‍💼', videoUrl: 'https://storage.googleapis.com/vidsimplify/taylor_input.mp4' },
      { id: 'clone', name: 'Sarah Clone', icon: '🤖', videoUrl: 'https://storage.googleapis.com/vidsimplify/vidsimplify-3naw7g%20(online-video-cutter.com)%20(1).mp4' }
    ]
  },
  {
    id: 2,
    ...
    isInteractive: true,
    personalityOptions: [
      { id: 'original', name: 'Original Mike', icon: '👨‍🏫', videoUrl: 'https://storage.googleapis.com/vidsimplify/drump_2_demo.mp4' },
      { id: 'clone', name: 'Mike Clone', icon: '🤖', videoUrl: 'https://storage.googleapis.com/vidsimplify/vidsimplify-3naw7g%20(online-video-cutter.com).mp4' }
    ]
  },
  {
    id: 3,
...
export default function InteractivePersonalityClonePlayer({ isPreview = false }: InteractivePersonalityClonePlayerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Video Player */}
      <div>
        <h4 className="text-xl font-bold text-white mb-4 text-center"> Vidsimplify cloned video of them</h4>
