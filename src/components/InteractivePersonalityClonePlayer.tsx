...
const demoVideos = [
  ...
  },
  {
    ...
    personalityOptions: [
      ...
      { id: 'clone', name: 'Cloned Video', icon: '🤖', videoUrl: 'https://storage.googleapis.com/vidsimplify/rocky_vid.mp4' }
    ]
  },
  {
    id: 3,
...
export default function InteractivePersonalityClonePlayer({ isPreview = false }: InteractivePersonalityClonePlayerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Video Player */}
      <div>
        <h4 className="text-xl font-bold text-white mb-4 text-center"> Check their cloned video</h4>
