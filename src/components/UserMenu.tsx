...
import { User, LogOut, Settings, Video, Coins } from 'lucide-react';
    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50">
          ...
          <div className="p-3 border-b border-slate-700">
            <div className="flex items-center justify-between bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg p-2.5">
