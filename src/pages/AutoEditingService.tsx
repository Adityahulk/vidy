            ...
            <div id="demo-video" className="mt-16 sm:mt-20">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-400">See intelligent video editing decisions in real-time</p>
                </div>
                <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl overflow-hidden">
                  <div className="aspect-video bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <h4 className="text-xl font-semibold text-white mb-2">Auto-Editing Demo</h4>
                      <p className="text-slate-400 text-sm">Watch AI make professional editing decisions</p>
                    </div>
                  </div>
